                ...
                <div className="lg:col-span-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <FeatureCard 
                            ...
                            description="Keep your data consistent and up-to-date instantly." 
                            color="text-red-600"
                        />
                        <FeatureCard 
                            icon={Trello} 
                            title="Cross-Platform" 
                            description="Seamless experience on web, iOS, and Android." 
                            color="text-blue-600"
                        />
                        <FeatureCard 
                            icon={Star} 
                            title="User-Focused" 
                            description="Designed with a beautiful, intuitive user interface." 
